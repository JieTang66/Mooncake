...
#
# openEuler / RHEL-family replacement for the repository root dependencies.sh only.
# Ascend-specific extras (yaml-cpp, msgpack-c, etc.) stay in
# scripts/ascend/dependencies_ascend_installation.sh and must be run separately.
#
# Usage (from repository root):
#   bash scripts/ascend/dependencies_openeuler.sh -y
